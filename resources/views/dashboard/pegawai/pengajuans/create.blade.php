...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('dashboard.pegawai.pengajuans.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group {{ $errors->has('nama_kegiatan') ? 'has-error' : '' }}">
                            ...
                            <textarea type="text" id="nama_kegiatan" name="nama_kegiatan" class="form-control" style="height: 100px;"
                                placeholder="Nama Kegiatan . . ." maxlength="255" required></textarea>
                        ...
                        <div class="form-group {{ $errors->has('jenis') ? 'has-error' : '' }}" id="jenislainnya_input"
                            ...
                            <input type="text" id="jenis_input" name="jenis" class="form-control"
                                value="{{ old('jenis', isset($pengajuan) ? $pengajuan->jenis : '') }}" maxlength="255" disabled>
                            @if ($errors->has('jenis'))
                                <p class="help-block text-danger">
                            ...
                            <select
                                ...
                                @foreach ($pengendali_teknis as $pengendali_teknis)
                                    <option value="{{ $pengendali_teknis->id }}"
                                        {{ old('pengendali_teknis', '') === (string) $pengendali_teknis->id ? 'selected' : '' }}>
                            ...
                            <select name="anggota[]" id="anggota" class="form-control select2bs4" multiple="multiple"
                                ...
                                @foreach ($anggota as $anggota)
                                    <option value="{{ $anggota->id }}"
                                        {{ in_array($anggota->id, old('anggota', [])) || (isset($pengajuan) && $pengajuan->anggota->contains($anggota->id)) ? 'selected' : '' }}>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" id="tujuan" name="tujuan[]" class="form-control"
                                                value="{{ old('tujuan', isset($pengajuan) ? $pengajuan->tujuan : '') }}"
                                                required>
