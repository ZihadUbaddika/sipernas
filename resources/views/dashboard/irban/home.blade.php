            ...
            <div class="row">
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-info">
                        ...
                        <a href="{{ route('dashboard.irban.pengajuans.index') }}" class="small-box-footer">Lihat Selengkapnya <i
                ...
                <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-warning">
                        ...
                        <a href="{{ route('dashboard.irban.programkegiatans.index') }}" class="small-box-footer">Lihat Selengkapnya <i
                                class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- ./col -->
