...
@section('add_route', route('dashboard.inspektur.programkegiatans.index'))
...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col-md-8">
                    {{ trans('id.lihat') }} {{ trans('id.pengajuan.programkegiatan_singular') }}
                </div>
                <!-- <div class="col-md-4 text-right">
                    <form action="{{ route('dashboard.inspektur.pengajuans.cetak_notadinas', $pengajuan->id) }}" method="POST"
                        style="display: inline-block;" class="mt-2">
                        @csrf
                        <button type="submit" class="btn btn-sm btn-warning"><i class="fas fa-print" aria-hidden="true"></i> Cetak nota dinas</button>
                    </form>
                </div> -->
            </div>
        </div>
