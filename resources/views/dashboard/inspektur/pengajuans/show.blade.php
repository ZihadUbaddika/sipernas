...
@section('add_route', route('dashboard.inspektur.pengajuans.index'))
        ...
        <div class="card-body">
            <table class="table table-bordered table-striped">
                <tbody>
                    ...
                    @if ($pengajuan->status_pengajuan == 'disetujui_irban' && Gate::check('is_inspektur'))
                        <form action="{{ route('dashboard.inspektur.pengajuans.submit', $pengajuan->id) }}" method="POST"
